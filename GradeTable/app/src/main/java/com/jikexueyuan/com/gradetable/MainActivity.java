...
//                    Toast.makeText(getApplicationContext(), mGradeList.get(0).getCourse_name(), Toast.LENGTH_SHORT).show();//测试是否获得到了数据
                    adapter = new Grade_adapter(MainActivity.this, R.layout.grade_item_list, mGradeList);//建立适配器
...
//                    adapter = new Grade_adapter(MainActivity.this, R.layout.grade_item_list, list);//建立适配器
//                    listview.setAdapter(adapter);
//
//                }
//                else{
