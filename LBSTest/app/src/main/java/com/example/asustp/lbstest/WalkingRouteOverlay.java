...
import com.example.asustp.lbstest.OverlayManager;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by asus tp on 2018/2/7.
 */
/**
...
public class WalkingRouteOverlay extends OverlayManager {
    ...
    public boolean onRouteNodeClick(int i) {
        if (mRouteLine.getAllStep() != null
            ...
            Log.i("baidumapsdk", "com.example.asustp.lbstest.WalkingRouteOverlay onRouteNodeClick");
        }
        return false;
    }
